package com.kyoin.portfolio.domain

import com.kyoin.portfolio.domain.constant.SkillType
import com.kyoin.portfolio.domain.entity.*
import com.kyoin.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    @PostConstruct // 스프링 건설 작업 후에 한번더 실행해줌
    fun initializeData() {
        ...
        val achievements = mutableListOf<Achievement>(
            Achievement(
                ...
                description = "개발",
                host = "도그",
                achievedDate = LocalDate.of(2023, 11, 22),
                isActive = true
            )
        )
